...
历史快照 `v0.1.165-pro.4` 的台账仍保留在第 13 节，供对照早期 Fork 差异。当前产品代码以 `v0.2.5-pro.2` 为准。
...
## 16. v0.2.5-pro.2 魔改核对

`v0.2.5-pro.2` 对照 `sub2魔改/sub2新站` 重新核了对账。魔改产品源码与上一版已并入的新站快照相同，运行时代码没有新的功能缺口。详细文件核对见 [魔改合并分析](MOGAI_MERGE_V0.2.5-PRO.2.md)。
