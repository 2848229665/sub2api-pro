...
INSERT INTO content_moderation_logs (
    ...
    cyber_request_stored_bytes, cyber_request_truncated, overturned
) VALUES (
    $1, $2, $3, $4, $5, $6, $7,
    ...
    $26, $27, $28, $29, $30, $31
		...
		log.CyberRequestStoredBytes, log.CyberRequestTruncated, log.Overturned,
...
SELECT
    ...
    (l.cyber_request_snapshot <> '') AS cyber_request_available, l.overturned, l.created_at
