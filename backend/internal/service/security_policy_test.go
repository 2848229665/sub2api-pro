...
func (r *securityPolicyTestModerationRepo) GetKeywordHitStats(context.Context, ContentModerationKeywordStatsFilter) (*ContentModerationKeywordStats, error) {
	return &ContentModerationKeywordStats{}, nil
}

func (r *securityPolicyTestModerationRepo) GetCyberPolicyRequestAudit(context.Context, int64) (*CyberPolicyRequestAudit, error) {
	return nil, nil
}
...
func (r *securityPolicyTestModerationRepo) UpdateCyberPolicyOutcome(context.Context, int64, int, bool, bool) error {
	return nil
}
