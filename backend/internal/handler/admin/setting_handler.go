...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		OpenAIPrioritySaturationPoolBalanceEnabled:             settings.OpenAIPrioritySaturationPoolBalanceEnabled,
		OpenAIPrioritySaturationAccountSharePercent:            settings.OpenAIPrioritySaturationAccountSharePercent,
		OpenAIPrioritySaturationAPIKeySharePercent:             settings.OpenAIPrioritySaturationAPIKeySharePercent,
		OpenAIPrioritySaturationEnterHighLoadPercent:           settings.OpenAIPrioritySaturationEnterHighLoadPercent,
		OpenAIPrioritySaturationExitHighLoadPercent:            settings.OpenAIPrioritySaturationExitHighLoadPercent,
