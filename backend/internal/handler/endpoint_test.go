...
func TestNormalizeInboundEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"/v1/realtime/calls", EndpointRealtimeCalls},
		{"/v1/realtime", EndpointRealtime},
		{"/v1/live", EndpointLive},
		{"/v1/live/rtc_123", EndpointLive},
		{"/v1/models", EndpointModels},
		{"/models", EndpointModels},
		{"/backend-api/codex/models", EndpointModels},
		{"/v1/memories/trace_summarize", EndpointCodexMemories},
		...
		{"/backend-api/codex/realtime/calls", EndpointRealtimeCalls},
		{"/backend-api/codex/memories/trace_summarize", EndpointCodexMemories},
		{"/memories/trace_summarize", EndpointCodexMemories},
...
func TestDeriveUpstreamEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"openai realtime calls", EndpointRealtimeCalls, "/v1/realtime/calls", service.PlatformOpenAI, EndpointRealtimeCalls},
		{"openai realtime sideband", EndpointRealtime, "/v1/realtime", service.PlatformOpenAI, EndpointRealtime},
		{"openai legacy live", EndpointLive, "/v1/live/call_123", service.PlatformOpenAI, EndpointLive},
		{"openai models", EndpointModels, "/backend-api/codex/models", service.PlatformOpenAI, EndpointModels},
		{"openai codex memories", EndpointCodexMemories, "/backend-api/codex/memories/trace_summarize", service.PlatformOpenAI, EndpointCodexMemories},
